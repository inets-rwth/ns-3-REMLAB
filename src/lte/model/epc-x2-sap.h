...
public:
  ...
  struct UePositionReport
  {
    uint64_t imsi;
    uint16_t targetCellId;
    uint16_t cellId; // source cell ID
    LteRrcSap::PositionReport report;
  };

  /// @brief REM point with best beam that is sent by LTE coordinator to the best gNB for a particular IMSI.
  struct LinkDataToGnb
  {
    uint64_t imsi;
    uint16_t targetCellId;

    LteRrcSap::LinkData linkData;
  };
...
public:
  ...
  // test: forwarding UE position from gNB to LTE coordinator
  virtual void SendPositionReportToCoordinator(EpcX2Sap::UePositionReport params) = 0;
  virtual void SendREMLinkDataToGnb(EpcX2Sap::LinkDataToGnb params) = 0;
};
...
public:
  ...
  //test
  virtual void RecvUePositionReport (LteRrcSap::PositionReport params) = 0;
  virtual void RecvREMLinkDataToGnb (LteRrcSap::LinkData params) = 0;
};
...
public:
  ...
  // test: forwarding UE position from gNB to LTE coordinator
  virtual void SendPositionReportToCoordinator(EpcX2Sap::UePositionReport params);
  virtual void SendREMLinkDataToGnb(EpcX2Sap::LinkDataToGnb params);
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendPositionReportToCoordinator (EpcX2Sap::UePositionReport params)
{
  m_x2->DoSendPositionReportToCoordinator(params);
}

template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendREMLinkDataToGnb (EpcX2Sap::LinkDataToGnb params)
{
  std::cout << "EpcX2SpecificEpcX2SapProvider<C>::SendREMLinkDataToGnb calling m_x2" << std::endl;
  m_x2->DoSendREMLinkDataToGnb(params);
}
...
public:
  ...
  //test: TODO
  virtual void RecvUePositionReport (LteRrcSap::PositionReport params);
  virtual void RecvREMLinkDataToGnb (LteRrcSap::LinkData params);
...
template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvUePositionReport(LteRrcSap::PositionReport params)
{
  m_rrc->DoRecvUePositionReport(params);
}

template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvREMLinkDataToGnb(LteRrcSap::LinkData params)
{
  m_rrc->DoRecvREMLinkDataToGnb(params);
}
