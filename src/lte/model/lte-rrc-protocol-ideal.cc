...
//test
void
LteUeRrcProtocolIdeal::DoSendPositionReport (LteRrcSap::PositionReport msg)
{
    std::cout << "LteUeRrcProtocolIdeal::DoSendPositionReport: scheduling a tx of position data to eNB" << std::endl;
    Simulator::Schedule(RRC_IDEAL_MSG_DELAY,
...
LteUeRrcProtocolIdeal::SetLteEnbRrcSapProvider ()
{
  ...
  std::cout << "LteUeRrcProtocolIdeal::SetLteEnbRrcSapProvider: called, but does nothing" << std::endl;
}
...
{
  std::cout << "LteUeRrcProtocolIdeal::DoSendSSBRSReport: reached a dead end. Nothing happens here" << std::endl;
}
...
{
  std::cout << "LteEnbRrcProtocolIdeal::SetLteEnbRrcSapProvider: m_enbRrcSapProvider is set to the passed LteEnbRrcSapProvider" << std::endl;
