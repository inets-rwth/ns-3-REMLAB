...
void
LteUePhy::DoStartBeamSweep (NrPhy::BeamSweepType beamSweepType)
{
  // WONT DO ANYTHING FOR LTEUEPHY, BUT HAS TO BE COPIED HERE
}

// labf
void
LteUePhy::DoSetRemBeam(LteRrcSap::LinkData linkData)
{
  // Overload for LTE. Does nothing. 
  // See NrUePhy for actual implementation.
}
  

void
LteUePhy::DoSetPhyIAFlag (bool iaState)
{
  
}

void 
LteUePhy::DoSetInitialIAState (bool iaState)
{
  
}

void
LteUePhy::DoCancelPendingReceivePduEvents ()
{
  
}

double 
LteUePhy::DoGetLastPerceivedSinr ()
{
  // WONT DO ANYTHING FOR LTEUEPHY
}

void 
LteUePhy::DoConfigureCSIRSResources (std::pair<uint8_t, uint8_t> startingSubframeSlotPair,
                  uint8_t csiRSOffset,
...
void 
LteUePhy::DoNotifyHandoverSuccessful ()
{
