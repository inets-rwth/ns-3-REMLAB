...
protected:
  ...
  //test
  void SerializePositionReport (LteRrcSap::PositionReport report) const;
  ...
  //test
  Buffer::Iterator DeserializePositionReport (LteRrcSap::PositionReport *report, Buffer::Iterator bIterator);
...
//test
/**
* This class manages the serialization/deserialization of PositionReport IE
*/
class PositionReportHeader : public RrcUlDcchMessage
{
public:
  PositionReportHeader ();
  ~PositionReportHeader ();
  ...
  /**
  * Receives a PositionReportHeader IE and stores the contents into the class attributes
  * @param msg The information element to parse
  */
  void SetMessage (LteRrcSap::PositionReport msg);

  /**
  * Returns a PositionReportHeader IE from the values in the class attributes
  * @return A PositionReportHeader, as defined in LteRrcSap
  */
  LteRrcSap::PositionReport GetMessage () const;

private:
  LteRrcSap::PositionReport m_positionReport; ///< position report
