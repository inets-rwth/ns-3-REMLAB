...
public:
  ...
  // labf
  virtual void SetRemBeam(LteRrcSap::LinkData linkData) = 0;
...
public:
  ...
  virtual void SwitchToIdleRA () = 0; // labf
...
public:
  ...
  // labf
  virtual void SetRemBeam(LteRrcSap::LinkData linkData);
...
// labf
template <class C>
void MemberLteUeCphySapProvider<C>::SetRemBeam(LteRrcSap::LinkData linkData)
{
  m_owner->DoSetRemBeam (linkData);
}
...
public:
  ...
  virtual void SwitchToIdleRA (); // labf
...
template <class C>
void
MemberLteUeCphySapUser<C>::SwitchToIdleRA ()
{
  return m_owner->DoSwitchToIdleRA ();
}
