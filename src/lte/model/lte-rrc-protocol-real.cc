...
//test
void
LteUeRrcProtocolReal::DoSendPositionReport (LteRrcSap::PositionReport msg)
{
    ...
    positionReportHeader.SetMessage (msg);

    packet->AddHeader (positionReportHeader);
...
{
  std::cout << "LteUeRrcProtocolReal::DoSendSSBRSReport: reached a dead end. Nothing happens here" << std::endl;
}
...
{
  std::cout << "LteEnbRrcProtocolReal::SetLteEnbRrcSapProvider: called and setting m_enbRrcSapProvider to a passed LteEnbRrcSapProvider pointer" << std::endl;
