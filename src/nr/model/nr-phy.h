...
public:
  ...
  bool m_rlmOn;
  bool m_ssbRlmOn; // test: this is flexRLM code. Reacting to SSB reports for beam selection
...
protected:
  ...
  double m_noiseFigure {0.0};            //!< Noise figure e(attribute)
  ...
  /// BEAMS TB Monitored via Radio-Link-Monitoring procedure
